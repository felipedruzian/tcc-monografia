...
O protocolo experimental executado contemplou os seguintes cenários:
...
Para avaliar o desempenho da arquitetura proposta, foram coletadas métricas computacionais e métricas de qualidade da localização/mapeamento. Além das métricas quantitativas, foi realizada avaliação qualitativa do mapa gerado.
...
Os resultados quantitativos e as evidências visuais encontram-se consolidados no Capítulo \ref{cap-resultados-discussao}.
