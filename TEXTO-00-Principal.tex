...
\usepackage[normalem]{ulem}       % Para o tachado (\sout)
\usepackage{tabularx}             % Já deve ter, mas confira
...
\title{Otimização de navegação autônoma para robôs de serviço: análise de desempenho do Visual SLAM em hardware com recursos limitados}

\author{Druzian}{Felipe Barreto}
...
\advisor[Prof.~Dr.]{Betemps}{Carlos Michel}
...
\defesa{11}{dezembro}{2025}                       % data da defesa - dia, mês e ano
...
%
%  --> MODIFICADO: todas palavras-chave ficam separadas entre si por ponto e vírgula e finalizadas por ponto. 
...
\begin{listofabbrv}{UNIPAMPA}
        ...
        \item[MPSoC] \textit{Multiprocessor System-on-Chip}
        \item[Nav2] \textit{Navigation2}
        \item[PWM] \textit{Pulse-Width Modulation} (modulação por largura de pulso)
        \item[RAM] \textit{Random Access Memory}
        \item[RGB-D] \textit{Red, Green and Blue -- Depth}
        ...
        \item[vSLAM] \textit{Visual Simultaneous Localization and Mapping}
\end{listofabbrv}
...
\input{TEXTO-02-Introducao}

\chapter{Fundamentação Teórica}
\label{cap-fundamentacao-teorica}
\input{TEXTO-03-FundamentacaoTeorica}

\chapter{Material e métodos}
\label{cap-metodologia}
\input{TEXTO-04-Metodologia}

\chapter{Trabalhos Correlatos}
\label{cap-trabalhos-relacionados}
\input{TEXTO-05-TrabalhosRelacionados}

\chapter{Desenvolvimento do Protótipo da Plataforma Robótica}
\label{cap-desenvolvimento}
\input{TEXTO-06-Desenvolvimento}

\chapter{Resultados e Discussão}
\label{cap-resultados-discussao}
\input{TEXTO-07-ResultadosDiscussao}

\chapter{Conclusão}
\label{cap-conclusao}
\input{TEXTO-08-Conclusao}
