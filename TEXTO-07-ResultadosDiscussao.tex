...
Essa revisão reforça a conclusão parcial do trabalho: o sistema ainda não possui odometria robusta para navegação autônoma, mas possui microdeslocamentos calibráveis e uma odometria visual RGB-D funcional sob condições controladas. Para novas coletas, o protocolo deve incluir pré-aquecimento do Kinect, cena iluminada e texturizada, uso de tópicos raw locais, análise do drift apenas após a primeira odometria real e separação entre runs de qualidade de SLAM e runs de stress mecânico.
